...
struct ref_inner_product_fwd_t : public gpu::generic::sycl::primitive_t {
    ...
    struct pd_t : public gpu_inner_product_fwd_pd_t {
        ...
        status_t init(impl::engine_t *engine) {
            ...
            auto wei_wrap = memory_desc_wrapper(weights_md());
            ...
            if (detail::get_dim_order(src_wrap.ndims(), src_wrap.strides())
                    != detail::get_dim_order(
                            wei_wrap.ndims(), wei_wrap.strides())) {
            ...
            if (with_bias()) {
                ...
                CHECK(memory_desc_init_by_tag(bias_reshaped, 2,
                        reshaped_bias_dims, bias_md->data_type,
                        format_tag::ab));
            }
